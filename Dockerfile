...
FROM fredericklab/basecontainer:v0.4.2 AS build-stage
...
ENV BASECONTAINERPLUS_BUILD_TIME=$BUILD_TIME
ENV BASECONTAINERPLUS_BRANCH=$BRANCH
ENV BASECONTAINERPLUS_GITVERSION=${GITVERSION}
ENV BASECONTAINERPLUS_GITSHA=${GITSHA}
ENV BASECONTAINERPLUS_GITDATE=${GITDATE}

RUN echo "BRANCH: "$BASECONTAINERPLUS_BRANCH
RUN echo "BUILD_TIME: "$BASECONTAINERPLUS_BUILD_TIME
RUN echo "GITVERSION: "$BASECONTAINERPLUS_GITVERSION
RUN echo "GITSHA: "$BASECONTAINERPLUS_GITSHA
RUN echo "GITDATE: "$BASECONTAINERPLUS_GITDATE
